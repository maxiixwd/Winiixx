...
$$$/    $$$ |/ $$   |$$ | $$$ |/ $$   |/ $$   |$$ |  $$ |
$$/      $$/ $$$$$$/ $$/   $$/ $$$$$$/ $$$$$$/ $$/   $$/                                                                                                                                                                                                                                      
[√][1;35m〓〓〓〓〓〓〓〓〓〓【MASTERMIND WINIIX】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓
[√][1;32mAuthor  : 【WINIIX LARKAW】
[√][1;33mGitHub  : 【】WINIIX LARKAW
[√][1;36m Tool  : ︻╦デ╤━╼【 WHTSAPP FYT TOLL BY WINIIX】╾━╤デ╦︻
[√][1;35m〓〓〓〓〓〓〓〓〓〓【 MASTERMIND WINIIX】〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;35m [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓【WINIIX LARKAW XWD】 〓〓〓〓〓〓〓〓〓〓〓〓〓〓 〓]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 [ONFIIRE WINIIX] 〓〓〓〓〓〓〓〓〓〓〓〓〓〓〓 ]");
            console.log('');
